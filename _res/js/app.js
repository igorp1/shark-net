...
var node_config = {
    colors :{
        "free net node" :   "#6096FA",
        "wired net node" :  "#4CD16F",
        "user" :            "#D14724"
    },
    icons : {
...
function initMap() {
    ...
    map.addListener('click', function(e) {
        ...
        var click_position = {lat: e.latLng.lat(), lng: e.latLng.lng()}        
        addNewNodeAt(click_position);

    });

}

function addNewNodeAt(latLng){

    var nodeType = document.getElementById("node-type-selector").value;
